...
The build spec is [`DESIGN.md`](DESIGN.md). The order for finishing the map is [`PLAN.md`](PLAN.md). The archive rule is [`ARCHIVE.md`](ARCHIVE.md). Device writes them. Web adds proposals under **Web additions** and does not write the file rows.
