...
The build spec is [`DESIGN.md`](DESIGN.md). The order for finishing the map is [`PLAN.md`](PLAN.md). Device writes both. Web adds proposals under **Web additions** and does not write the file rows.
